...
const {YoutubeLiveViewAdapter2} = require('../util/Adapter');
...
class YoutubeLiveViewTrends2 extends React.Component {
    constructor(props) {
        super(props);

        const {originUrl} = props;
        this.adapter = new YoutubeLiveViewAdapter2({originUrl});
    ...
    componentDidMount() {
        return (async()=>{
            this.trendsList = (await this.adapter.getTrendsList()).adjustTrendsByDate({days:360});
    ...
    updateTrendsList() {
        ...
        trendsList.adjustTrendsByDate({days:360});
...
Object.assign(module.exports,{YoutubeLiveViewTrends2});
